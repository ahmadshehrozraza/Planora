...
const pricingPlans = [
  ...
  },
  {
    ...
    price: "$12",
    period: "/user/month",
    description: "Advanced tools for growing teams that need more control.",
    features: [
  ...
  },
  {
    name: "Enterprise",
    price: "Custom",
    description: "Unmatched security and performance for large organizations.",
    features: [
      "Everything in Pro",
      "Advanced Analytics",
      "SSO & SAML",
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-md">
        <div className="container mx-auto px-2 h-16 flex items-center justify-between">
          <div className="flex items-center">
            <PlanoraWheel size={50} handWidth={3} duration="6s" />
            <span className="font-bold text-xl tracking-tight">Planora</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Button asChild size="sm" className="shadow-sm">
              <Link href={`/workspaces/${workspacesData.documents[0].id}`}>
                Get Started
              </Link>
            </Button>
        ...
        <section className="relative pt-24 pb-32 overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 text-balance">
              Planora is the ultimate workspace for your team. Build custom
              workflows, visualize deadlines with intelligent calendars, and
        ...
        <section id="pricing" className="py-24 bg-card border-t border-border">
          <div className="container mx-auto px-4 md:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                No hidden fees. Choose the perfect plan for your team's needs.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
              {pricingPlans.map((plan, idx) => (
                <div
                  key={idx}
                  className={`relative flex flex-col p-8 rounded-3xl border ${plan.popular ? "border-primary shadow-lg bg-background" : "border-border bg-background"}`}
                >
                  {plan.popular && (
                  ...
                  >
                    <Link
                      href={plan.price === "Free" ? "/sign-up" : "/sign-in"}
                    >
                      {plan.buttonText}
                    </Link>
                  </Button>
        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-8 relative z-10 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-10 max-w-2xl mx-auto">
              Join thousands of teams already using Planora to manage their
              projects, tasks, and deadlines in one unified workspace.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center gap-2 mb-6">
                <PlanoraWheel size={30} handWidth={2} />
                <span className="font-bold text-lg">Planora</span>
              </div>
