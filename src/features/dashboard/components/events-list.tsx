                    ...
                    {data.map((event) => (
                        <li key={event.id}>
                            <Link href={`/workspaces/${workspaceId}/events/${event.id}`}>
                                <Card className="shadow-none rounded-lg hover:bg-accent/50 transition p-0 border border-border bg-card">
                                                    ...
                                                    <div className="flex flex-col min-w-0 flex-1">
                                                        ...
                                                        <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs text-muted-foreground mt-1">
                                                            <div className="flex items-center gap-x-1.5 shrink-0">
                                                                ...
                                                                <span>{event.date ? format(new Date(event.date), 'hh:mm a') : 'All Day'}</span>
                                                            </div>
                                                            {event.project?.name && (
                    ...
                    {data.length === 0 && (
                        <li className="text-center py-8">
                            <div className="text-muted-foreground">
                                ...
                                <p className="text-sm">Your schedule is clear for the next 7 days.</p>
                            </div>
                        </li>
                    )}
                </ul>
